...
/**
 * Created by Kelvin on 2/12/2017.
 */
...
public class RateMyApp {
    ...
    public void showRateDialog(final SharedPreferences.Editor editor) {
        ...
        View layout = inflater.inflate(R.layout.dialog_rate_myapp, null);
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, "kcervanr@gmail.com");
                intent.putExtra(Intent.EXTRA_SUBJECT, "Problemas con findTeacher: ");
                intent.putExtra(Intent.EXTRA_TEXT, "Ingresa el problema que tienes");
